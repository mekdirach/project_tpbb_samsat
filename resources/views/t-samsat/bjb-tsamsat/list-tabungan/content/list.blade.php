...
<div class="modal fade" id="modals-default">
    <div class="modal-dialog">
        <form action="{{ route('bjb-t-samsat.list-tabungan.export') }}" method="POST" class="modal-content">
            @csrf
    ...
    <script type="text/javascript">
        ...
        function loadData() {
            $('.datatables-demos').dataTable({
                ...
                ajax: {
                    url: "{{ route('bjb-t-samsat.list-tabungan.list') }}",
                    type: 'POST',
                    data: {
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        mRender: function(data, type, row) {
                            var html
                            html =
                                `<a href="{{url('/bjb-t-samsat/list-tabungan/show/${row.nomor_polisi}')}}" title="Detail" type="button" class="btn btn-sm btn-outline-secondary" ><i class="ion ion-md-eye"></i></a>`
                            return html
                        }
                    },
                    {
