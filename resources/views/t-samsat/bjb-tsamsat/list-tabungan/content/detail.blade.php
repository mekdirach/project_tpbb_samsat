    ...
    <div class="card-body">
        <div class="row justify-content-start d-flex">
            ...
            <div class="col-md-auto ml-3">
                <div class="row m-0">
                    <h6> : {{ $record->nomor_polisi }}</h6>
                </div>
                <div class="row m-0">
                    <p> : {{ $record->jenis_kendaraan }}</p>
                </div>
                <div class="row m-0">
                    <p> : {{ $record->tahun_pajak }}</p>
                </div>
            </div>
        </div>
        <div class="row mt-3">
                ...
                <div class="card-body" style="border-radius: 5px; background: rgba(224, 229, 232, 0.75);">
                    <div class="row">
                        ...
                        <div class="col-md-auto">
                            ...
                            <div class="row">
                                <p>{{ $record->pajak_tgl_rencana_bayar }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body" style="border-radius: 5px; background: rgba(224, 229, 232, 0.75);">
                    <div class="row">
                        ...
                        <div class="col-md-auto">
                            ...
                            <div class="row">
                                <p>Rp {{ number_format($record->pajak_total_tagihan) }}</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-3 mt">
                        ...
                        <div class="row"><p>{{ $record->nm_pemilik}}</p></div>
                        ...
                        <div class="row"><p>{{ $record->registrasi_jenis}} </p></div>

                        <div class="row"><h6 class="mb-0">Tgl. Registrasi</h6></div>
                        <div class="row"><p>{{ $record->registrasi_tgl}} </p></div>

                        <div class="row"><h6 class="mb-0">Nomor Mesin</h6></div>
                        <div class="row"><p>{{ $record->no_mesin}}</p></div>
                    </div>
                    <div class="col-3">
                        ...
                        <div class="row"><p>{{ $record->informasi_lain}}</p></div>

                        <div class="row"><h6 class="mb-0">No. HP</h6></div>
                        <div class="row"><p>{{ $record->notif_phone}}</p></div>

                        <div class="row"><h6 class="mb-0">Email</h6></div>
                        <div class="row"><p>{{ $record->notif_email}}</p></div>

                        <div class="row"><h6 class="mb-0">Jenis Kendaraan</h6></div>
                        <div class="row"><p>{{ $record->jenis_kendaraan}}</p></div>
                    </div>
                    <div class="col-3">
                        <div class="row"><h6 class="mb-0">Tanggal Awal Blokir</h6></div>
                        <div class="row"><p>{{ $record->autoblokir_awal_tgl}}</p></div>

                        <div class="row"><h6 class="mb-0">Tanggal Akhir Blokir</h6></div>
                        <div class="row"><p>{{ $record->autoblokir_akhir_tgl}}</p></div>

                        <div class="row"><h6 class="mb-0">Nominal Pembayaran</h6></div>
                        <div class="row"><p>Rp {{ number_format($record->pajak_total_tagihan)}}</p></div>

                        <div class="row"><h6 class="mb-0">Nominal Setoran</h6></div>
                        <div class="row"><p>Rp {{ number_format($record->nominal_setoran)}}</p></div>
