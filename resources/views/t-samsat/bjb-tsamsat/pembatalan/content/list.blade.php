            ...
            <div class="col-6">
                ...
                <div class="col-sm-12">
                    <div class="input-group">
                        <input type="text" class="form-control required" placeholder="Masukan Tahun"
                    ...
                    <div class="col-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-9">
                                <div class="form-group">
                                    <div class="input-group">
                                        <input type="text" class="form-control" readonly id="owner"
                                            name="owner">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-9">
                                <div class="form-group">
                                    <div class="input-group">
                                        <input type="text" class="form-control" readonly id="kepemilikan"
                                            name="kepemilikan">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-9">
                                <div class="form-group">
                                    <div class="input-group">
                                        <input type="text" class="form-control" readonly id="jatuh_tempo"
                                            name="jatuh_tempo">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-9">
                                <div class="form-group">
                                    <div class="input-group">
                                        <input type="text" class="form-control" readonly id="nama_nasabah"
                                            name="nama_nasabah">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-9">
                                <div class="form-group">
                                    <div class="input-group">
                                        <input type="text" class="form-control" readonly id="acc_type"
                                            name="acc_type">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-9">
                                <div class="form-group">
                                    <div class="input-group">
                                        <input type="text" class="form-control" readonly id="currency"
                                            name="currency">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-6">
                        <div class="row">
                            ...
                            <div class="col-9">
                                <div class="form-group">
                                    <div class="input-group">
                                        <input type="text" class="form-control" readonly id="no_hp"
                                            name="no_hp">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-9">
                                <div class="form-group">
                                    <div class="input-group">
                                        <input type="text" class="form-control" readonly id="no_ref"
                                            name="no_ref">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-9">
                                <div class="form-group">
                                    <div class="input-group">
                                        <input type="text" class="form-control" readonly id="nominal_blokir"
                                            name="nominal_blokir">
                                    </div>
                                </div>
                            </div>
        ...
        $(document).ready(function() {
            $('#btnCekNopol').click(function(e) {
                ...
                if (validasiInput()) {
                    $.ajax({
                        type: "POST",
                        url: "{{ route('bjb-t-samsat.pembatalan.detail') }}",
                        data: {
                        ...
                        success: function(response) {
                            if (response.rc == '0000') {
                                ...
                                $('#nominal_blokir').val('Rp ' + number_format(response.data[0]
                                    .nominal_setoran))
                                $('#total').val('Rp ' + number_format(response.data[0]
                                    .pajak_total_tagihan))
            ...
            $('#btnModalPembatalan').click(function(e) {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ route('bjb-t-samsat.pembatalan.update') }}",
                    data: {
                        _token: $('meta[name="csrf-token"]').attr('content'),
                        nopol: nopol,
