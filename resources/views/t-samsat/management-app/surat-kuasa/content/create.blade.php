...
<div class="card">
    <div class="card-body">
        <form action="{{ route('management-app.surat-kuasa-samsat.create') }}" method="POST">
            @csrf
            <div class="form-row">
            ...
            <div class="row justify-content-end">
                <a href="{{ route('management-app.surat-kuasa-samsat') }}" type="button" class="btn btn-default mr-1" data-dismiss="modal">Batal</a>
