    ...
    <div class="card card-primary card-outline card-outline-tabs col-sm-12">
        <div class="row">
            <div class="card-body col-12">
                @if (request()->segment(3) == 'create-page')
                    @include('t-samsat.management-app.surat-kuasa.content.create')
                @elseif (request()->segment(3) == 'show')
                    @include('t-samsat.management-app.surat-kuasa.content.detail')
                @elseif (request()->segment(3) == 'edit')
                    @include('t-samsat.management-app.surat-kuasa.content.edit')
                @else
                    @include('t-samsat.management-app.surat-kuasa.content.list')
                @endif
            </div>
        </div>
    </div>
