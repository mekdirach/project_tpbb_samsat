...
$(document).ready(function () {
    ...
    $('#saveBtn').click(function () {
                ...
                if (name == "") {
                    ...
                    var url = edit ? "{{ route('management-app.role-management.edit') }}" :
                        "{{ route('management-app.role-management.create') }}";
...
function loadData() {
    $('.datatables-demos').dataTable({
        ...
        ajax: {
            url: "{{ route('management-app.role-management.list') }}",
            type: 'POST',
            data: {
        ...
        columns: [
            ...
            },
            {
                ...
                mRender: function(data, type, row) {
                    ...
                    html  += `<a href="{{url('/management-app/role-management/show/permission/${row.id}')}}" title="Detail" type="button" class="btn btn-sm btn-outline-secondary" ><i class="ion ion-md-eye"></i></a>`
...
function modalEdit(id) {
    ...
    $.ajax({
      url: "{{ route('management-app.role-management.show') }}",
      method: 'POST',
      data: {
        _token: $('meta[name="csrf-token"]').attr('content'),
        id: id
