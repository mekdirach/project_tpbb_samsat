        ...
        <div class="row">
            <div class="card-body col-12">
                @if (request()->segment(3) == 'create-page')
                    @include('management-app.surat-kuasa.content.create')
                @elseif (request()->segment(3) == 'show')
                    @include('management-app.surat-kuasa.content.detail')
                @elseif (request()->segment(3) == 'edit')
                    @include('management-app.surat-kuasa.content.edit')
                @else
                    @include('management-app.surat-kuasa.content.list')
                @endif
            </div>
        </div>
    </div>
