    ...
    <div class="card-body">
        <div class="row justify-content-start d-flex">
            ...
            <div class="col-md-auto ml-3">
                <div class="row m-0">
                    <h6> : {{ $record->mp_p_id }}</h6>
                </div>
                <div class="row m-0">
                    <p> : {{ $record->mp_p_nama }}</p>
                </div>
                <div class="row m-0">
                    <p> : {{ $record->mp_mkk_nama }}</p>
                </div>
            </div>
        </div>
        <div class="row mt-3">
                ...
                <div class="card-body" style="border-radius: 5px; background: rgba(224, 229, 232, 0.75);">
                    <div class="row">
                        ...
                        <div class="col-md-auto">
                            ...
                            <div class="row">
                                <p>{{ $record->mp_p_pembayaran_cutoff }} Day</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body" style="border-radius: 5px; background: rgba(224, 229, 232, 0.75);">
                    <div class="row">
                        ...
                        <div class="col-md-auto">
                            ...
                            <div class="row">
                                <p>{{ $record->mp_p_pembayaran_date }}</p>
                            </div>
                        </div>
                    </div>
                </div>
