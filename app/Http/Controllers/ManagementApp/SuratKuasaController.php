...
class SuratKuasaController extends Controller
{
    public function index()
    {
        ...
        return view('management-app.surat-kuasa.index', compact('data'));
    }
    ...
    public function createPage() {
        $fields = Schema::getColumnListing('mp_pbb_customer');
        return view('management-app.surat-kuasa.content.create', compact('fields'));
    }
    ...
    public function create(Request $request)
    {
        ...
        $result = redirect()->route('management-app.surat-kuasa')->with([
            'message'     => $message,
            'alert-type'  => $alert
        ]);
    ...
    public function show($id)
    {
        ...
        return view('management-app.surat-kuasa.index', compact('fields', 'record', 'content'));
    }
    ...
    public function edit($id)
    {
        ...
        $createHTML = new wHTML($phpWord);
        $content = $createHTML->getContent();
        return view('management-app.surat-kuasa.index', compact('fields', 'record', 'content', 'values'));
    }
