    ...
    <div class="card-header">
        <div id="accordion">
            ...
            <div id="accordion-1" class="collapse mt-2" data-parent="#accordion">
                ...
                <?php if(substr(Session::get('user')->kodeCabang, 0, 1) == 'D' || substr(Session::get('user')->kodeCabang, 0, 1) == 'd'): ?>
...
<div class="modal fade" id="modals-default">
    <div class="modal-dialog">
        <form action="<?php echo e(route('laporan.transaksi-sukses-exort')); ?>" method="POST" class="modal-content">
            <?php echo csrf_field(); ?>
    ...
    <script type="text/javascript">
        ...
        function loadData() {
            $('.datatables-demos').dataTable({
                ...
                ajax: {
                    url: "<?php echo e(route('laporan.transaksi-sukses-list')); ?>",
                    type: 'POST',
                    data: {
        ...
        function modalView(id) {
            ...
            console.log(id);
            $.ajax({
                url: "<?php echo e(route('laporan.transaksi-sukses-detail')); ?>",
                method: 'POST',
                data: {
                    _token: $('meta[name="csrf-token"]').attr('content'),
                    id: id
...
<?php $__env->stopPush(); ?>
<?php /**PATH /Users/elizzwell/Documents/work/t-pajak/tpbb-devbjb/resources/views/laporan/transaksi-sukses/content/list.blade.php ENDPATH**/ ?>