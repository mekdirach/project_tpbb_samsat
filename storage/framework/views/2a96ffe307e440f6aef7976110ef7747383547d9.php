    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#saveBtn').click(function() {
                ...
                var url = edit ? "<?php echo e(route('management-app.provinsi.edit')); ?>" :
                    "<?php echo e(route('management-app.provinsi.create')); ?>";
        ...
        function loadData() {
            ...
            $('.datatables-demos').dataTable({
                ...
                ajax: {
                    url: "<?php echo e(route('management-app.provinsi.list')); ?>",
                    type: 'POST',
                    data: {
        ...
        function modalView(id) {
            ...
            edit = true
            $.ajax({
                url: "<?php echo e(route('management-app.provinsi.show')); ?>",
                method: 'POST',
                data: {
                    _token: $('meta[name="csrf-token"]').attr('content'),
                    id: id
...
<?php $__env->stopPush(); ?>
<?php /**PATH /Users/elizzwell/Documents/work/t-pajak/tpbb-devbjb/resources/views/management-app/provinsi/content/list.blade.php ENDPATH**/ ?>