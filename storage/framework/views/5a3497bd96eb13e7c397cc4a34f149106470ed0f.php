                    ...
                    <div class="col-6">
                        ...
                        <div class="col-sm-12">
                            <select class="custom-select" name="tipe_laporan" id="tipe_laporan">
                                ...
                                <option value="blokir">Laporan Blokir</option>
                                <option value="transaksi-gagal">Laporan Transaksi Gagal</option>
                                <option value="transaksi-sukses">Laporan Transaksi Sukses</option>
                            </select>
                        </div>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        ...
        function loadData() {
            $('.datatables-demos').dataTable({
                ...
                ajax: {
                    url: "<?php echo e(route('download-manager.list')); ?>",
                    type: 'POST',
                    data: {
...
<?php $__env->stopPush(); ?>
<?php /**PATH /Users/elizzwell/Documents/work/t-pajak/tpbb-devbjb/resources/views/download-manager/content/list.blade.php ENDPATH**/ ?>