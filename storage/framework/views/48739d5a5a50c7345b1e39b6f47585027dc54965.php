    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#saveBtn').click(function() {
                ...
                var url = edit ? "<?php echo e(route('management-app.pemda.edit')); ?>" :
                    "<?php echo e(route('management-app.pemda.create')); ?>";
        ...
        function loadData() {
            ...
            $('.datatables-demos').dataTable({
                ...
                ajax: {
                    url: "<?php echo e(route('management-app.pemda.list')); ?>",
                    type: 'POST',
                    data: {
                ...
                columns: [{
...

                    {
                        ...
                        mRender: function(data, type, row) {
                            ...
                            html +=
                                `<a href="<?php echo e(url('/management-app/pemda/show/${row.id}')); ?>" title="Detail" type="button" class="btn btn-sm btn-outline-secondary" ><i class="ion ion-md-eye"></i></a>`
                            return html
                        }
                    },
                ]
        ...
        function modalEdit(id) {
            ...
            $.ajax({
                url: "<?php echo e(route('management-app.pemda.detail')); ?>",
                method: 'POST',
                data: {
                    _token: $('meta[name="csrf-token"]').attr('content'),
                    id: id
...
<?php $__env->stopPush(); ?>
<?php /**PATH /Users/elizzwell/Documents/work/t-pajak/tpbb-devbjb/resources/views/management-app/pemda/content/list.blade.php ENDPATH**/ ?>