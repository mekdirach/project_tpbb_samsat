    ...
    <div class="card-body">
        <div class="row justify-content-start d-flex">
            ...
            <div class="col-md-auto ml-3">
                <div class="row m-0">
                    <h6> : <?php echo e($record->mp_p_id); ?></h6>
                </div>
                <div class="row m-0">
                    <p> : <?php echo e($record->mp_p_nama); ?></p>
                </div>
                <div class="row m-0">
                    <p> : <?php echo e($record->mp_mkk_nama); ?></p>
                </div>
            </div>
        </div>
        <div class="row mt-3">
                ...
                <div class="card-body" style="border-radius: 5px; background: rgba(224, 229, 232, 0.75);">
                    <div class="row">
                        ...
                        <div class="col-md-auto">
                            ...
                            <div class="row">
                                <p>Rp <?php echo e($record->mp_p_fee); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body" style="border-radius: 5px; background: rgba(224, 229, 232, 0.75);">
                    <div class="row">
                        ...
                        <div class="col-md-auto">
                            ...
                            <div class="row">
                                <p><?php echo e($record->mp_p_pembayaran_cutoff); ?> Day</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body" style="border-radius: 5px; background: rgba(224, 229, 232, 0.75);">
                    <div class="row">
                        ...
                        <div class="col-md-auto">
                            ...
                            <div class="row">
                                <p><?php echo e($record->mp_p_pembayaran_date); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php /**PATH /Users/elizzwell/Documents/work/t-pajak/tpbb-devbjb/resources/views/management-app/scheduler/content/detail.blade.php ENDPATH**/ ?>