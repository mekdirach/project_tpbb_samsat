    ...
    <div class="mb-3">
        ...
        <div id="smartwizard-6-step-4" class="card animated fadeIn">
            <div class="card-body">
                ...
                <input id="link" hidden value="<?php echo e(route('approval-samsat')); ?>">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#btnCekNorek').click(function (e) {
         ...
         $('#btnCekNopol').click(function (e) {
            ...
            if (validasiInputNop()) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo e(route('bjb-t-samsat.registrasi-samsat.cek-nopol')); ?>",
                    data: {
                        _token: $('meta[name="csrf-token"]').attr('content'),
        ...
        $('#btnSimulasi').click(function (e) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(route('bjb-t-samsat.registrasi-samsat.simulasi')); ?>",
                data: {
                    _token: $('meta[name="csrf-token"]').attr('content'),
                    tglBlokir : tglBlokir,
...
<?php $__env->stopPush(); ?>
<?php /**PATH /Users/elizzwell/Documents/work/t-pajak/tpbb-devbjb/resources/views/t-samsat/bjb-tsamsat/registrasi/content/registrasi.blade.php ENDPATH**/ ?>