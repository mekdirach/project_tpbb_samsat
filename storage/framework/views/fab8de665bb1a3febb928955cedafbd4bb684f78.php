    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#saveBtn').click(function() {
                ...
                var url = edit ? "<?php echo e(route('management-app.account-type.edit')); ?>" :
                    "<?php echo e(route('management-app.account-type.create')); ?>";
        ...
        function loadData() {
            ...
            $('.datatables-demos').dataTable({
                ...
                ajax: {
                    url: "<?php echo e(route('management-app.account-type.list')); ?>",
                    type: 'POST',
                    data: {
        ...
        function modalEdit(id) {
            ...
            $.ajax({
                url: "<?php echo e(route('management-app.account-type.show')); ?>",
                method: 'POST',
                data: {
                    _token: $('meta[name="csrf-token"]').attr('content'),
                    id: id
...
<?php $__env->stopPush(); ?>
<?php /**PATH /Users/elizzwell/Documents/work/t-pajak/tpbb-devbjb/resources/views/management-app/account-type/content/list.blade.php ENDPATH**/ ?>