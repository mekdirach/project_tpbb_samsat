...
<div class="modal fade" id="modals-default">
    <div class="modal-dialog">
        <form action="<?php echo e(route('pbb.daftar-tpbb.export')); ?>" method="POST" class="modal-content">
            <?php echo csrf_field(); ?>
    ...
    <script type="text/javascript">
        ...
        function loadData() {
            $('.datatables-demos').dataTable({
                ...
                ajax: {
                    url: "<?php echo e(route('pbb.daftar-tpbb.list')); ?>",
                    type: 'POST',
                    data: {
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        mRender: function(data, type, row) {
                            var html
                            html =
                                `<a href="<?php echo e(url('/pbb/daftar-tpbb/show/${row.id}')); ?>" title="Detail" type="button" class="btn btn-sm btn-outline-secondary" ><i class="ion ion-md-eye"></i></a>`
                            return html
                        }
                    },
                    {
...
<?php $__env->stopPush(); ?>
<?php /**PATH /Users/elizzwell/Documents/work/t-pajak/tpbb-devbjb/resources/views/pbb/daftar-tpbb/content/list.blade.php ENDPATH**/ ?>