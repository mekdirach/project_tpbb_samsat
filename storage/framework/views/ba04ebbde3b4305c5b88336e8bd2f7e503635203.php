...
<div class="modal fade" id="modals-default">
    <div class="modal-dialog">
        <form action="<?php echo e(route('laporan.pendaftaran-export')); ?>" method="POST" class="modal-content">
            <?php echo csrf_field(); ?>
    ...
    <script type="text/javascript">
        ...
        function loadData() {
            $('.datatables-demos').dataTable({
                ...
                ajax: {
                    url: "<?php echo e(route('laporan-samsat.registrasi-list')); ?>",
                    type: 'POST',
                    data: {
...
<?php $__env->stopPush(); ?>
<?php /**PATH /Users/elizzwell/Documents/work/t-pajak/tpbb-devbjb/resources/views/t-samsat/laporan/registrasi/content/list.blade.php ENDPATH**/ ?>