    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#saveParam').click(function() {
                ...
                var url = "<?php echo e(route('management-app.parameter-sistem.edit')); ?>";
                $.ajax({
                    url: url,
                    method: 'POST',
                    data: formData,
        ...
        function loadData() {
            $.ajax({
                url: "<?php echo e(route('management-app.parameter-sistem.list')); ?>",
                type: "GET",
                success: function(response) {
                    var data = response[0];
...
<?php $__env->stopPush(); ?>
<?php /**PATH /Users/elizzwell/Documents/work/t-pajak/tpbb-devbjb/resources/views/management-app/parameter-sistem/content/list.blade.php ENDPATH**/ ?>