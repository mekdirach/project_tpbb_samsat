    ...
    <div class="tab-content">
        <div class="tab-pane fade show active" id="navs-top-responsive-link-1">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-3 mt">
                        <div class="row"><h6 class="mb-0">Nama Objek Pajak</h6></div>
                    ...
                    <div class="col-3">
                        ...
                        <div class="row"><h6 class="mb-0">Kota/Kabupaten</h6></div>
                        <div class="row"><p><?php echo e($record->mp_mkk_nama); ?></p></div>

                        <div class="row"><h6 class="mb-0">Kecamatan</h6></div>
                        <div class="row"><p><?php echo e($record->pbb_c_kecamatan); ?></p></div>

                        <div class="row"><h6 class="mb-0">Kelurahan</h6></div>
                    ...
                    <div class="col-3">
                        ...
                        <div class="row"><h6 class="mb-0">Biaya Admin</h6></div>
                    ...
                    <div class="col-3">
                        <div class="row"><h6 class="mb-0">Layanan Notifikasi</h6></div>
                        <div class="row"><p><?php echo e($record->status_inputan); ?></p></div>

                        <div class="row"><h6 class="mb-0">Status Notifikasi</h6></div>
                        <div class="row"><p><?php echo e($record->status_inputan); ?></p></div>

                        <div class="row"><h6 class="mb-0">Nomor Ponsel</h6></div>
                        <div class="row"><p><?php echo e($record->pbb_c_phone); ?></p></div>

                        <div class="row"><h6 class="mb-0">Alamat Email</h6></div>
...
<?php /**PATH /Users/elizzwell/Documents/work/t-pajak/tpbb-devbjb/resources/views/pbb/daftar-tpbb/content/detail.blade.php ENDPATH**/ ?>