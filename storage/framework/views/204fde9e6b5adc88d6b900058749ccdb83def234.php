        ...
        <div class="row">
            <div class="card-body col-12">
                <?php if(request()->segment(3) == 'create-page'): ?>
                    <?php echo $__env->make('management-app.surat-kuasa.content.create', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <?php elseif(request()->segment(3) == 'show'): ?>
                    <?php echo $__env->make('management-app.surat-kuasa.content.detail', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <?php elseif(request()->segment(3) == 'edit'): ?>
                    <?php echo $__env->make('management-app.surat-kuasa.content.edit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <?php else: ?>
                    <?php echo $__env->make('management-app.surat-kuasa.content.list', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <?php endif; ?>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/elizzwell/Documents/work/t-pajak/tpbb-devbjb/resources/views/management-app/surat-kuasa/index.blade.php ENDPATH**/ ?>