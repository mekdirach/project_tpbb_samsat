<section class="content">
    <div class="container-fluid">
        <div class="row">
            ...
            <input type="hidden" class="form-control" name="role_id" id="roleId" value="<?php echo e($role->id); ?>" readonly>
        </div>
        <div class="row pt-4">
            <div class="col">
...
<script type="text/javascript">
    ...
    function functionPermission(rolePermissionId) {
        $(':checkbox').each(function(i) {
            if ($(this).data('id') == `permission${rolePermissionId}`) {
                ...
                $.ajax({
                    url: "<?php echo e(route('management-app.role-management.access.update-permission')); ?>",
                    type: 'POST',
                    data: {
    ...
    function load() {
        ...
        $.ajax({
            url: "<?php echo e(route('management-app.role-management.access-permission')); ?>",
            type: 'POST',
            data: {
                _token: $('meta[name="csrf-token"]').attr('content'),
                role_id: $('#roleId').val()
...
<?php $__env->stopPush(); ?>
<?php /**PATH /Users/elizzwell/Documents/work/t-pajak/tpbb-devbjb/resources/views/management-app/role-management/content/detail.blade.php ENDPATH**/ ?>