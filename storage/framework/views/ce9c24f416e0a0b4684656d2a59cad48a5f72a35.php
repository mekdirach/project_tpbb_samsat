<div class="card">
    <div class="card-body">
        <form action="<?php echo e(route('management-app.surat-kuasa-samsat.update')); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
<?php /**PATH /Users/elizzwell/Documents/work/t-pajak/tpbb-devbjb/resources/views/t-samsat/management-app/surat-kuasa/content/edit.blade.php ENDPATH**/ ?>