        ...
        $(document).ready(function() {
            $('#btnCekNop').click(function(e) {
                ...
                if (validasiInput()) {
                    $.ajax({
                        type: "POST",
                        url: "<?php echo e(route('pbb.pembatalan-tpbb.detail')); ?>",
                        data: {
            ...
            $('#btnModalPembatalan').click(function(e) {
                ...
                if (notes.length > 0) {
                    $.ajax({
                        type: "POST",
                        url: "<?php echo e(route('pbb.pembatalan-tpbb.update')); ?>",
                        data: {
                            _token: $('meta[name="csrf-token"]').attr('content'),
                            accountNumber: accountNumber,
                            nop: nop,
...
<?php $__env->stopPush(); ?>
<?php /**PATH /Users/elizzwell/Documents/work/t-pajak/tpbb-devbjb/resources/views/pbb/pembatalan/content/list.blade.php ENDPATH**/ ?>