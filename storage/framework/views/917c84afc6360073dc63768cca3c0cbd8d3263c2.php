    ...
    <div class="card-header">
        <div id="accordion">
            ...
            <div id="accordion-1" class="collapse mt-2" data-parent="#accordion">
                ...
                <div class="row justify-content-center">
                    <div class="col-6">
                        <label class="col-form-label col-sm-6">Tanggal Blokir</label>
                        <div class="col-sm-12">
...
<div class="modal fade" id="modals-default">
    <div class="modal-dialog">
        <form action="<?php echo e(route('laporan.blokir-export')); ?>" method="POST" class="modal-content">
            <?php echo csrf_field(); ?>
    ...
    <script type="text/javascript">
        ...
        function loadData() {
            $('.datatables-demos').dataTable({
                ...
                ajax: {
                    url: "<?php echo e(route('laporan.blokir-list')); ?>",
                    type: 'POST',
                    data: {
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        width: "9%",
                        data: 'mp_pbb_cl_nop_name',
                    },
                    {
                        title: "Nomor Rekening",
                        width: "5%",
                        data: 'mp_pbb_ab_src_extacc',
                    },
                    {
                        title: "Jenis Registrasi",
                        width: "5%",
                        data: 'mp_pbb_cl_reg_type',
                    },
                    {
                        title: "Jumlah Tagihan",
                        data: 'mp_pbb_ab_amount',
                        width: "7%",
                        mRender: function(data, type, row) {
                            var result = `Rp ${(data)}`
                            return result
...
<?php $__env->stopPush(); ?>
<?php /**PATH /Users/elizzwell/Documents/work/t-pajak/tpbb-devbjb/resources/views/laporan/blokir/content/list.blade.php ENDPATH**/ ?>